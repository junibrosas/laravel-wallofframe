...
-- Dumping structure for table previboo_wallofframe.assigned_roles
...
-- Dumping data for table previboo_wallofframe.assigned_roles: ~0 rows (approximately)
/*!40000 ALTER TABLE `assigned_roles` DISABLE KEYS */;
/*!40000 ALTER TABLE `assigned_roles` ENABLE KEYS */;


-- Dumping structure for table previboo_wallofframe.contacts
...
-- Dumping data for table previboo_wallofframe.contacts: ~2 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.countries
...
-- Dumping data for table previboo_wallofframe.countries: ~208 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.images
...
-- Dumping data for table previboo_wallofframe.images: ~0 rows (approximately)
/*!40000 ALTER TABLE `images` DISABLE KEYS */;
/*!40000 ALTER TABLE `images` ENABLE KEYS */;


-- Dumping structure for table previboo_wallofframe.migrations
CREATE TABLE IF NOT EXISTS `migrations` (
  `migration` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `batch` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table previboo_wallofframe.migrations: ~18 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.password_reminders
...
-- Dumping data for table previboo_wallofframe.password_reminders: ~0 rows (approximately)
/*!40000 ALTER TABLE `password_reminders` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_reminders` ENABLE KEYS */;


-- Dumping structure for table previboo_wallofframe.payment_methods
...
-- Dumping data for table previboo_wallofframe.payment_methods: ~1 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.permissions
...
-- Dumping data for table previboo_wallofframe.permissions: ~0 rows (approximately)
/*!40000 ALTER TABLE `permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `permissions` ENABLE KEYS */;


-- Dumping structure for table previboo_wallofframe.permission_role
...
-- Dumping data for table previboo_wallofframe.permission_role: ~0 rows (approximately)
/*!40000 ALTER TABLE `permission_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `permission_role` ENABLE KEYS */;


-- Dumping structure for table previboo_wallofframe.products
...
-- Dumping data for table previboo_wallofframe.products: ~23 rows (approximately)
...
INSERT INTO `products` (`id`, `status_id`, `type_id`, `category_id`, `brand_id`, `title`, `content`, `excerpt`, `slug`, `price`, `width`, `height`, `is_available`, `views`, `image`, `image_type`, `image_original_type`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(40, 5, 1, 1, 1, '', '', '', '', 0.00, '2000', '2000', 1, 0, 'LQw0WY9ck3VzZ9jZPmtL.jpg', 'square', 'square', '2015-01-13 07:09:53', '2015-01-13 18:24:53', '2015-01-13 18:24:53'),
	(41, 5, 1, 1, 1, '', '', '', '', 0.00, '1366', '768', 0, 0, 'OcfnszfjxsoATs6OneH6.jpg', 'square', 'horizontal', '2015-01-13 19:27:45', '2015-01-13 19:29:24', '2015-01-13 19:29:24'),
	(42, 5, 1, 1, 1, '', '', '', '', 0.00, '1366', '768', 0, 0, 'T4BBrOdOQgJ2dt5E78ah.jpg', 'square', 'horizontal', '2015-01-13 19:30:22', '2015-01-13 19:31:02', '2015-01-13 19:31:02'),
	(43, 5, 1, 1, 1, '', '', '', '', 0.00, '1366', '768', 0, 0, 't79pf8JQY92FfTSDh8OT.jpg', 'square', 'horizontal', '2015-01-13 19:31:49', '2015-01-13 19:31:49', NULL),
	(44, 5, 1, 1, 1, '', '', '', '', 0.00, '1366', '768', 0, 0, 'P3nLS2C3cKYZJYx899aD.jpg', 'square', 'horizontal', '2015-01-14 06:49:55', '2015-01-14 07:17:44', NULL),
	(45, 5, 1, 1, 1, '', '', '', '', 0.00, '1366', '768', 0, 0, 'cQvk3fELjvVBpnidIcT8.jpg', 'square', 'horizontal', '2015-01-14 08:02:27', '2015-01-14 08:02:27', NULL);
/*!40000 ALTER TABLE `products` ENABLE KEYS */;


-- Dumping structure for table previboo_wallofframe.product_brands
...
-- Dumping data for table previboo_wallofframe.product_brands: ~6 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.product_categories
...
-- Dumping data for table previboo_wallofframe.product_categories: ~3 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.product_statuses
...
-- Dumping data for table previboo_wallofframe.product_statuses: ~6 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.product_types
...
-- Dumping data for table previboo_wallofframe.product_types: ~3 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.product_views
...
-- Dumping data for table previboo_wallofframe.product_views: ~1 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.profiles
...
-- Dumping data for table previboo_wallofframe.profiles: ~11 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.roles
...
-- Dumping data for table previboo_wallofframe.roles: ~0 rows (approximately)
/*!40000 ALTER TABLE `roles` DISABLE KEYS */;
/*!40000 ALTER TABLE `roles` ENABLE KEYS */;


-- Dumping structure for table previboo_wallofframe.shipping_addresses
...
-- Dumping data for table previboo_wallofframe.shipping_addresses: ~5 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.transactions
...
-- Dumping data for table previboo_wallofframe.transactions: ~4 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.transaction_statuses
...
-- Dumping data for table previboo_wallofframe.transaction_statuses: ~3 rows (approximately)
...
-- Dumping structure for table previboo_wallofframe.users
...
-- Dumping data for table previboo_wallofframe.users: ~11 rows (approximately)
...
INSERT INTO `users` (`id`, `type_id`, `username`, `email`, `photo`, `password`, `confirmation_code`, `remember_token`, `confirmed`, `created_at`, `updated_at`) VALUES
	(1, 1, 'admin', 'admin@gmail.com', '', '$2y$10$IjVbkrtt88h31ZFNYDpXsus5XuWNmvKY1loBewR4d5HMHGcc3Jpiu', '33d450254053f8499427a3a3c8ac3f62', '8yJAebtYygYnpMG0Fp5W8YLOUak4gEbGPcuTCqa2j2ffGe3i9C32K3yXPAr2', 1, '2014-12-18 07:56:31', '2015-01-14 06:05:29'),
...
-- Dumping structure for table previboo_wallofframe.user_types
...
-- Dumping data for table previboo_wallofframe.user_types: ~2 rows (approximately)
/*!40000 ALTER TABLE `user_types` DISABLE KEYS */;
INSERT INTO `user_types` (`id`, `name`, `slug`, `description`, `deleted_at`, `created_at`, `updated_at`) VALUES
	(1, 'Administrator', 'admin', '', NULL, '2015-01-09 14:31:47', '2015-01-09 14:31:47'),
	(2, 'Customer', 'customer', '', NULL, '2015-01-09 14:31:47', '2015-01-09 14:31:47');
/*!40000 ALTER TABLE `user_types` ENABLE KEYS */;


-- Dumping structure for table previboo_wallofframe.wishlists
...
-- Dumping data for table previboo_wallofframe.wishlists: ~3 rows (approximately)
